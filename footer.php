        ...
        <div class="footer-contact-section">
            <div class="contact-form-container">
                <div class="contact-info">
                    ...
                    <p class="contact-subtitle">Ready to experience luxury vegan beauty? Contact us for personalised
                        recommendations.</p>
                    ...
                    <div class="contact-details">
                        <div class="contact-item">
                            ...
                            <span><?php echo get_theme_mod('contact_email', 'mellluxe.info@gmail.com'); ?></span>
                        </div>
        ...
        <div class="footer-bottom">
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    <h4 class="footer-brand-title">Mell Luxe</h4>
                    <p class="footer-brand-desc">Luxury vegan beauty products, handcrafted with love and sustainable
                        practices.</p>

                    <!-- Social Links -->
                    <div class="footer-social">
                        <a href="https://www.instagram.com/mell_luxe/" class="social-link" aria-label="Instagram">
                        ...
                        <a href="https://facebook.com/61563792317066" class="social-link" aria-label="Facebook">
                            <svg viewBox="0 0 24 24" fill="currentColor">
                                <path
                                    d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                            </svg>
                        </a>
                        <a href="https://www.tiktok.com/@mell.luxe" class="social-link" aria-label="TikTok">
                            <svg viewBox="0 0 24 24" fill="currentColor">
                                <path
                                    d="M12.75 2v12.19a2.06 2.06 0 1 1-2.06-2.06c.11 0 .22.01.33.03V9.98a5.06 5.06 0 1 0 3.72 4.89V7.5c.44.25.92.44 1.44.54V5.98c-.5-.07-.98-.23-1.44-.47V2h-2z" />
                            </svg>
                        </a>
                        <a href="https://www.ebay.co.uk/sch/i.html?item=365114818121&rt=nc&_trksid=p4429486.m3561.l161210&_ssn=mell_luxe"
                            class="social-link" aria-label="eBay">
                            <svg viewBox="0 0 60 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <text x="0" y="19" font-family="Arial, Helvetica, sans-serif" font-size="24"
                                    font-weight="bold">
                        ...
                        <a href=" https://mellluxe.etsy.com" class="social-link" aria-label="Etsy">
                            <svg viewBox="0 0 60 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <text x="0" y="19" font-family="Arial, Helvetica, sans-serif" font-size="20"
                                    font-weight="bold" fill="#F56400">Etsy</text>
                            </svg>
                        </a>
                    </div>
                </div>
                ...
                <div class="footer-links-section">
                    ...
                    <div class="footer-navigation">
                        <ul class="footer-links">
                            ...
                            <li>
                                <a href="<?php echo esc_url(home_url('/about/')); ?>" class="legal-link">About Us</a>
                            </li>
                            <li>
                                <a href="<?php echo esc_url(home_url('/blog/')); ?>" class="legal-link">Blog</a>
                            </li>
                            <li>
                                <a href="<?php echo esc_url(home_url('/faq/')); ?>" class="legal-link">FAQ</a>
                            </li>
                            <li>
                                <a href="<?php echo esc_url(home_url('/shipping-and-returns/')); ?>"
                                    target="_blank">Shipping and returns</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <!-- Newsletter Signup -->
                <!-- Removed newsletter signup as requested -->
            </div>
            ...
            <div class="footer-copyright">
                <div class="copyright-content">
                    <p>&copy; <?php echo date('Y'); ?> <?php bloginfo('name'); ?>.
                        <?php _e('All rights reserved.', 'mellluxe'); ?></p>
                    ...
                    <div class="footer-legal">
                        <a href="<?php echo esc_url(home_url('/terms-and-privacy/')); ?>" class="legal-link">Terms and
                            Privacy</a>
                    </div>
                </div>
            </div>
 ...
 */
function mellluxe_footer_fallback_menu()
{
    echo '<ul class="footer-links">';
    echo '<li><a href="' . esc_url(home_url('/')) . '">' . __('Home', 'mellluxe') . '</a></li>';

    if (class_exists('WooCommerce')) {
        echo '<li><a href="' . esc_url(get_permalink(wc_get_page_id('shop'))) . '">' . __('Shop', 'mellluxe') . '</a></li>';
    }
    ...
    if (function_exists('get_privacy_policy_url') && get_privacy_policy_url()) {
        echo '<li><a href="' . esc_url(get_privacy_policy_url()) . '">' . __('Privacy Policy', 'mellluxe') . '</a></li>';
    }
