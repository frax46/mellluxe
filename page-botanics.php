<?php
/**
 * Template Name: Botanics Page
 * Description: Displays only products in the "botanics" category.
 */
    ...
    <section class="shop-hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Botanics Collection</h1>
                    <p class="hero-subtitle">Natural botanical ingredients for radiant, healthy skin — pure, plant-powered beauty</p>
                    <div class="hero-description">
                        <p>Botanics is a small extension of Mell Luxe — a place for natural pieces gathered or crafted with the same care as our skincare. Everything here begins in nature: a sprout, a seed, a wild pinecone. Each item is made by hand, with no glue, no glitter, no paints, and no toxic chemicals that could harm you, pets, children, or wildlife.</p>
                        <p>This space is for simple, honest gifts and home pieces: living plants ready to grow, seasonal ornaments made from real materials, and small creations that bring warmth and a natural touch to your home.</p>
                        <p>Every item in Botanics reflects our belief that nature gives us everything we need when we treat it with respect.</p>
                    </div>
                </div>

                <div class="hero-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/System Images/table.jpg"
                        alt="Botanics Collection">
                </div>
            </div>
        </div>
    </section>
    <section class="shop-content">
        <div class="container botanics">
            <div class="shop-header">
                <div class="page-info">
                    <h2 class="page-title"><?php echo esc_html(get_the_title() ?: 'Botanics'); ?></h2>
            ...
            <div class="products-section">
                <div class="woocommerce">
                    ...
                    if (function_exists('woocommerce_shortcode_products')) {
                        ...
                        $shortcode = '[products category="botanics" limit="12" columns="4" paginate="true" orderby="meta_value" meta_key="_stock_status" order="ASC"]';
