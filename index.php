    ...
    <section class="snap-section hero-section" id="hero">
        ...
        <div class="hero-container">
            ...
            <div class="hero-next-section">
                ...
                <div class="text2">
                    <p>
                        Our collection is meticulously crafted in
                        the UK, using the finest vegan ingredients to ensure a premium experience.
                        From invigorating bath bombs and rejuvenating facial polishes to nourishing body oils and
                        serums, we offer a wide range of products designed to enhance your self-care routine...
                    </p>
                </div>
                ...
                <div class="showcase-content">
                    <div class="showcase-images">
                        <div class="product-display">
                            <img src="<?php echo get_template_directory_uri(); ?>\images\Whole Sale\Daily Facial Oil 5.20£\PXL_20240720_174133088_edited.jpg"
                                alt="Bath Products" class="hero-product-img">
                        </div>
                    </div>
                    <div class="showcase-text">
                        <div class="text-content">
                            <p>From invigorating bath bombs and rejuvenating facial polishes to nourishing body oils and
                                serums, we offer a wide range of products designed to enhance your self-care routine...
                            </p>
                    ...
                    <div class="brand-content">
                        <div class="brand-images">
                            <div class="brand-product-left">
                                <img src="<?php echo get_template_directory_uri(); ?>\images\Whole Sale\Calming Luxury Bath Salts 3.60£\PXL_20240720_175212393_edited_edited_edited_edited.png"
                                    alt="Luxury Body Oil" class="brand-product-img">
                            </div>
                            <div class="brand-text-center">
                                <div class="brand-description">
                                    <p>... nature meets luxury in every handcrafted product. Our collection is
                                        meticulously crafted in the UK, using the finest vegan ingredients to ensure a
                                        premium experience.</p>
                                    <p>From invigorating bath bombs and rejuvenating</p>
                                </div>
                            </div>
                            <div class="brand-product-right">
                                <img src="<?php echo get_template_directory_uri(); ?>\images\Whole Sale\Oils - Firming Body Oil\IMG_1061_edited.jpg"
                                    alt="Facial Cleansing Dough" class="brand-product-img">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="products-container">
            ...
            <div class="products-showcase">
                ...
                <div class="showcase-description" style="grid-area: text">
                    <p>... Each item is thoughtfully packaged in recyclable, eco-friendly materials, reflecting
                        Mell's commitment to sustainability and the environment. Our formulations harness the
                        power of nature's best, like hyaluronic acid, vegan squalane, blue spirulina, and
                        essential oils, to deliver visible results and unparalleled care.</p>
                </div>
                <div class="showcase-product-item product-top-left" style="grid-area: image1">
                    <div class="product-image-container">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Daily Facial Oil 5.20£/PXL_20240720_174133088_edited.jpg"
                            alt="Daily Facial Oil" class="showcase-product-image">
                    </div>
                </div>

                <div class="showcase-product-item product-top-right" style="grid-area: image2">
                    <div class="product-image-container">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Anti-Ageing Facial Serum 6£/PXL_20240720_172749777_edited.jpg"
                            alt="Anti-Ageing Facial Serum" class="showcase-product-image">
                    </div>
                </div>
                ...
                <div class="showcase-product-item product-left" style="grid-area: image3">
                    <div class="product-image-container">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Calming Luxury Bath Salts 3.60£/PXL_20240720_175212393_edited_edited_edited_edited.png"
                            alt="Calming Luxury Bath Salts" class="showcase-product-image">
                    </div>
                </div>
                ...
                <div class="showcase-product-item product-right" style="grid-area: image4">
                    <div class="product-image-container">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Oils - Firming Body Oil/IMG_1061_edited.jpg"
                            alt="Firming Body Oil" class="showcase-product-image">
                    </div>
                </div>
                ...
                <div class="showcase-product-item product-bottom" style="grid-area: image5">
                    <div class="product-image-container">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Singles/Polish/IMG_1501 2_edited_edited.jpg"
                            alt="Facial Polish" class="showcase-product-image">
                    </div>
                </div>
            </div>
    ...
    <div class="best-container">
                ...
                <div class="main-product-container">
                    <div class="main-product-image">
                        <img id="mainProductImg"
                            src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Brow, Lash & Nail Beauty Serum 4£/PXL_20240720_174441659_edited.jpg"
                            alt="Beauty Serum" class="main-img">
                    </div>
                </div>
            ...
            <div class="thumbnail-slider">
                <div class="thumbnail-container" id="thumbnailContainer">
                    <div class="thumbnail-item active"
                        data-img="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Brow, Lash & Nail Beauty Serum 4£/PXL_20240720_174441659_edited.jpg">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Brow, Lash & Nail Beauty Serum 4£/PXL_20240720_174441659_edited.jpg"
                            alt="Beauty Serum">
                    </div>
                    <div class="thumbnail-item"
                        data-img="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Royal 24k Gold Facial Elixir/bf86a4c9-6fda-42b7-9244-9dbcbe4a0c40_edited.jpg">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Royal 24k Gold Facial Elixir/bf86a4c9-6fda-42b7-9244-9dbcbe4a0c40_edited.jpg"
                            alt="24k Gold Elixir">
                    </div>
                    <div class="thumbnail-item"
                        data-img="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Calming Luxury Bath Salts 3.60£/PXL_20240720_175212393_edited_edited_edited_edited.png">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Calming Luxury Bath Salts 3.60£/PXL_20240720_175212393_edited_edited_edited_edited.png"
                            alt="Bath Salts">
                    </div>
                    <div class="thumbnail-item"
                        data-img="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Oils - Firming Body Oil/IMG_1061_edited.jpg">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Oils - Firming Body Oil/IMG_1061_edited.jpg"
                            alt="Body Oil">
                    </div>
                    <div class="thumbnail-item"
                        data-img="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Daily Facial Oil 5.20£/PXL_20240720_174133088_edited.jpg">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/Whole Sale/Daily Facial Oil 5.20£/PXL_20240720_174133088_edited.jpg"
                            alt="Facial Oil">
                    </div>
                </div>
        ...
        <div class="best-content-section">
            ...
            <div class="best-description">
                <p>Whether you're looking for a gift set to pamper a loved one or a personal treat to elevate your
                    skincare regimen, Mell Luxe provides the ultimate in natural, luxurious, and eco-conscious
                    beauty solutions.</p>
            </div>
        </div>
    </div>
