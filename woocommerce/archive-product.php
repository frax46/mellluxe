        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <p class="hero-subtitle">Handcrafted in the UK with 100% natural, vegan, and cruelty-free
                        ingredients</p>
                ...
                <div class="filters-bar">
                    <div class="filters-left">
                        <div class="results-info">
                            ...
                            ?>
                            <span
                                class="results-count"><?php echo sprintf(_n('%d Product', '%d Products', $total, 'mellluxe'), $total); ?></span>
                        </div>
                    ...
                    <div class="filters-right">
                        ...
                        <div class="sort-control">
                            ...
                            <select name="orderby" class="orderby" id="shop-orderby">
                                ...
                                ?>
                                <option value="menu_order" <?php selected($orderby, 'menu_order'); ?>>Default sorting
                                </option>
                                <option value="popularity" <?php selected($orderby, 'popularity'); ?>>Sort by
                                    popularity</option>
                                <option value="rating" <?php selected($orderby, 'rating'); ?>>Sort by average rating
                                </option>
                                <option value="date" <?php selected($orderby, 'date'); ?>>Sort by latest</option>
                                <option value="price" <?php selected($orderby, 'price'); ?>>Sort by price: low to high
                                </option>
                                <option value="price-desc" <?php selected($orderby, 'price-desc'); ?>>Sort by price:
                                    high to low</option>
                            </select>
                        </div>
                    </div>
